(function() {
  ...
  var designLink = document.getElementById('design-link');
  if (designLink) {
  ...
  function updateDesignLink() {
    var link = document.getElementById('design-link');
    if (!link) return;
    var d = getDesign();
    link.textContent = d === 'current' ? 'Design' : 'Design \u2192';
  }
